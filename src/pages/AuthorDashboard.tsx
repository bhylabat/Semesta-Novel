...
export default function AuthorDashboard() {
  ...
  useEffect(() => {
    ...
    const loadAuthorNovels = async () => {
      ...
      try {
        ...
        console.error('Failed to load author novels:', err);
  ...
  const totalViews = novels.reduce(
    (total, novel) => total + (novel.views ?? 0),
    0
  );

  const totalBookmarks = novels.reduce(
    (total, novel) => total + (novel.bookmark_count ?? 0),
    0
  );
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-8">
      ...
      <div className="card overflow-hidden">
        ...
        {/* Empty */}
        {!loadingNovels && !error && novels.length === 0 && (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1">
                    ...
                    <span className="text-xs text-muted">
                      {novel.bookmark_count ?? 0} bookmark
                    </span>
