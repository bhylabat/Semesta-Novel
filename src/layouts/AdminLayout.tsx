...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-bg flex">
      {/* Sidebar */}
      <aside
        className={`fixed md:sticky top-0 left-0 h-screen z-50 w-64 glass border-r border-white/10 transition-transform duration-300 ${
          sidebarOpen
            ? 'translate-x-0'
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-3 border-t border-white/10 space-y-1">
            <Link
              to="/"
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-muted hover:text-white hover:bg-white/5 transition-colors"
            >
